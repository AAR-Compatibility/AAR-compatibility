...
If you change the order of the sheets, which I recommend you not to do, make sure to also alter the "AAR_excel_to_SQL.py" file as this file directly reads the excel sheets and converts it to an SQL database. 
